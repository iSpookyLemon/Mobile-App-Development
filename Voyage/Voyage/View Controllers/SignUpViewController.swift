        ...
        if error != nil {
            ...
            Auth.auth().createUser(withEmail: email, password: password) { (result, err) in
                ...
                if err != nil {
                    ...
                    db.collection("users").document(result!.user.uid).setData(["firstname":firstName, "lastname":lastName, "fullnamelower": firstName.lowercased() + " " + lastName.lowercased(), "isSeller":false]) { (error) in
